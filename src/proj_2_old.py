...
def main():
    ...
    # position of handle
    twe, handtype = s.transformations_object("right_handle",x=0.4,y=0.0,z=-0.08, hand="right") # dla prawej lapy 10 normalnie 5 octo
    ...
    #rotating hand
    print("Rotating right writs by 90 deg around local y axis (right-hand side matrix multiplication)")
    T_B_Tr = s.velma.getTf("B", "Tr")
    T_B_Trd = T_B_Tr * PyKDL.Frame(PyKDL.Rotation.RotY(-90.0/180.0*math.pi))
    if not s.velma.moveCartImpRight([T_B_Trd], [2.0], None, None, None, None, PyKDL.Wrench(PyKDL.Vector(5,5,5), PyKDL.Vector(5,5,5)), start_time=0.5):
        exitError(8)
    if s.velma.waitForEffectorRight() != 0:
        exitError(9)
    ...
    rospy.sleep(1)
    T_B_Trd = PyKDL.Frame(PyKDL.Rotation.Quaternion( 0.0 , 0.0 , 0.0 , 1.0 ), PyKDL.Vector( box.p.x()-0.28 , box.p.y()-0.02 , box.p.z()+0.14 ))
    s.velma.moveCartImpRight([T_B_Trd], [3.0], None, None, None, None, PyKDL.Wrench(PyKDL.Vector(18,18,18), PyKDL.Vector(0.1,0.1,0.1)), start_time=0.5)
    rospy.sleep(5)
    ...
    #backin a lil bit with handle - 30 deg
        #calculating offset
    deg = 30
    side = 0.585/2
    ...
    print("backing up")
    #box = s.velma.getTf("B", "right_handle")
    T_B_Trd = PyKDL.Frame(PyKDL.Rotation.Quaternion( 0.0 , 0.0 , 0.0 , 1.0 ), PyKDL.Vector( box.p.x()-0.28+dx , box.p.y()+0.15-dy , box.p.z()+0.14))
    s.velma.moveCartImpRight([T_B_Trd], [3.0], None, None, None, None, PyKDL.Wrench(PyKDL.Vector(18,18,18), PyKDL.Vector(0.1,0.1,0.1)), start_time=0.5)
    rospy.sleep(2)
    ...
    box = s.velma.getTf("B", "right_handle")
    T_B_Trd = PyKDL.Frame(PyKDL.Rotation.Quaternion( 0.0 , 0.0 , 0.0 , 1.0 ), PyKDL.Vector( box.p.x()-0.28-0.1 , box.p.y()-0.01-0.1 , box.p.z()+0.14))
    s.velma.moveCartImpRight([T_B_Trd], [3.0], None, None, None, None, PyKDL.Wrench(PyKDL.Vector(18,18,18), PyKDL.Vector(0.1,0.1,0.1)), start_time=0.5)
    rospy.sleep(2)
    ...
    print("going around")
    T_B_Trd = PyKDL.Frame(PyKDL.Rotation.Quaternion( 0.0 , 0.0 , 0.0 , 1.0 ), PyKDL.Vector( box.p.x()-0.28-0.05 , box.p.y()+0.28 , box.p.z()+0.14))
    s.velma.moveCartImpRight([T_B_Trd], [3.0], None, None, None, None, PyKDL.Wrench(PyKDL.Vector(5,5,5), PyKDL.Vector(5,5,5)), start_time=0.5)
    rospy.sleep(2)
    print("going around finished")
    #hit door
    print("forward")
    T_B_Trd = PyKDL.Frame(PyKDL.Rotation.Quaternion( 0.0 , 0.0 , 0.0 , 1.0 ), PyKDL.Vector( box.p.x()-0.28+0.1 , box.p.y()+0.28 , box.p.z()+0.14))
    s.velma.moveCartImpRight([T_B_Trd], [3.0], None, None, None, None, PyKDL.Wrench(PyKDL.Vector(5,5,5), PyKDL.Vector(5,5,5)), start_time=0.5)
    rospy.sleep(2)
    print("forward finished")
    print("hit door")
    T_B_Trd = PyKDL.Frame(PyKDL.Rotation.Quaternion( 0.0 , 0.0 , 0.0 , 1.0 ), PyKDL.Vector( box2.p.x()-side/2 , (box2.p.y()-side/2)-0.1 , box2.p.z()+0.14))
    s.velma.moveCartImpRight([T_B_Trd], [3.0], None, None, None, None, PyKDL.Wrench(PyKDL.Vector(5,5,5), PyKDL.Vector(5,5,5)), start_time=0.5)
    rospy.sleep(2)
